...
@section('content')
                ...
                <ul class="collapsible z-depth-1" data-collapsible="accordion">
                    ...
                    <li>
                        ...
                        <div class="collapsible-body" style="position:relative" id="xml_collapsible_body">
                            ...
                            <label for="content_xml"></label><textarea id="content_xml" class="content content_height_transition content_xml_large" wrap="soft"></textarea>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div id="settings_dialog" class="modal modal-fixed-footer">
        <div class="modal-content">
            ...
            <div class="modal_section">
                ...
                <label for="settings_compiler_location"></label><input type="text" id="settings_compiler_location">
            </div>
            <div class="modal_section">
                <label><span class="translatable_sketchFolder">Sketch Folder</span>:</label>
                <label for="settings_sketch_location"></label><input type="text" id="settings_sketch_location">
            </div>
            <div class="modal_section">
                <label><span class="translatable_arduinoBoard">Arduino Board</span>:</label>
                <label for="board"></label><select name="settings_board" id="board">
            ...
            <div class="modal_section">
                ...
                <label for="serial_port"></label><select name="settings_serial" id="serial_port">
            ...
            <div class="modal_section">
                ...
                <label for="ide_settings"></label><select name="settings_ide" id="ide_settings">
            ...
            <div class="modal_section">
                ...
                <label for="language"></label><select name="settings_language" id="language"></select>
            </div>
        </div>
    ...
    <div id="gen_prompt" class="modal modal_small modal-fixed-footer">
        <div class="modal-content">
            ...
            <p><label for="gen_prompt_input"></label><input id="gen_prompt_input" value="test" /></p>
        </div>
        <div class="modal-footer">
